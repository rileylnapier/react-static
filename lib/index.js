      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 13:
            ...
            if (!inflight[path]) {
              inflight[path] = _axios2.default.get('/__config__/route' + path);
            }
            _context2.next = 18;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _axios2.default.get('/__config__/getroutes');
              ...
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  return function () {
                    ...
                    sitePropsPromise = _axios2.default.get('/__config__/siteProps');
                    return sitePropsPromise;
                  }();
